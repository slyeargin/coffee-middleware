      ...
      var compile = function() {
        ...
        fs.readFile(coffeePath, 'utf8', function(err, str){
          ...
          try {
            ...
            var compiledObj = options.compile(str, {filename: path.basename(coffeePath), sourceMap: true});
            ...
            console.log(typeof compiledObj.v3SourceMap, sourceMapObj);

            // Translate the sourcemap into a base64 comment
            var sourceMapObj = compiledObj.v3SourceMap,
                sourceMapStr = convertSourceMap.fromObject(sourceMapObj).toComment();

            // Append the comment to our source
