    ...
    if (regex.handle.test(pathname)) {
      ...
      var compile = function() {
        ...
        fs.readFile(coffeePath, 'utf8', function(err, str){
          ...
          try {
            var compiled = options.compile(str, {filename: coffeePath, bare: options.bare});
            ...
            // TODO: For source-maps, look into inlining them (e.g. https://github.com/thlorenz/inline-source-map)
